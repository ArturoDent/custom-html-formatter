...
describe( "Rule Impact Counts", () => {

  it( "no expected changes", () => {
    const input = `
<!DOCTYPE html>
<html>
<head>
  <title>Rule Impact Counts: no expected changes </title>
</head>
<body>
<h1>Example</h1>
</body>
...
`.trim();
  ...
  it( "body and html changes expected", () => {
    const input = `
<!DOCTYPE html>
<html>
  <head>
